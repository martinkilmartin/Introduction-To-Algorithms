...
test("matrix multiplication Strassen recursive A * B", () => {
  expect(squareMatrixMultiplyRecursive(MATRIX_A, MATRIX_B)).toStrictEqual(
    MATRIX_A_X_B
  )
})

test("matrix multiplication Strassen recursive B * A", () => {
  expect(squareMatrixMultiplyRecursive(MATRIX_B, MATRIX_A)).toStrictEqual(
    MATRIX_B_X_A
  )
})